...
ClassParser::ClassParser(std::string file_path) {
...
ClassParser::~ClassParser() {
    ...
    if (PrintDestruction) {
        std::cout << "*** destruct ClassParser ***" << std::endl;
    }
}

ClassFile* ClassParser::parse_from_file(std::string file_path) {
    _class_path = file_path;
    parse();
    return _classfile;
}

bool ClassParser::parse_magic() {
...
bool ClassParser::parse_version() {
...
bool ClassParser::parse_class_access_flags() {
...
bool ClassParser::parse_method_access_flags(ClassFileMethodInfo* minfo) {
...
bool ClassParser::parse_this_and_super_class() {
...
bool ClassParser::parse_interfaces() {
...
ClassFileAttributeInfo** ClassParser::get_attr_array(int count) {
...
ClassFileCodeAttribute* ClassParser::parse_code_attribute(ClassFileAttributeInfo *attr) {
...
bool ClassParser::parse_method_attributes(ClassFileMethodInfo* m) {
...
bool ClassParser::parse_methods() {
...
std::vector<Bytecode*> ClassParser::parseBytecode(u1 * code, int len) {
